# AegisFlow Deprecation Policy

## Purpose

This policy defines the process for deprecating and retiring artifacts
(skills and plugins) within the AegisFlow governance framework.
...
- Deprecation request is submitted via:
  ```bash
  aegis deprecate skill "Old Artifact" --replacement "New Artifact"
  ```
...
- Retirement is triggered via:
  ```bash
  aegis retire skill "Old Artifact"
  ```
...
- `aegis audit` flags deprecated artifacts approaching retirement
