#!/usr/bin/env python3
"""SkillForge CLI - Unified Lifecycle Governance Tool

The main command-line interface for managing skills and plugins
through the SkillForge governance framework.

Usage:
    forge init
    forge add-skill "Skill Name" --owner team-name --risk Medium
    forge validate
    forge promote skill "Skill Name"
    forge deprecate plugin plugin_name --replacement new_plugin
    forge retire skill "Skill Name"
    forge review skill "Skill Name"
    forge bump skill "Skill Name" --type minor
    forge list skills
    forge list plugins
    forge score
    forge audit
    forge telemetry plugin_name
"""
...
def find_skillforge_root():
    """Find the skillforge root directory by searching upward from CWD."""
    # First check if we're inside skillforge/
...
SKILLS_MD_TEMPLATE = """# SkillForge Skills Registry
...
def cmd_init(args):
    """Initialize SkillForge in the current repository."""
    target = os.path.join(os.getcwd(), "skillforge")

    if os.path.exists(target):
        print(f"SkillForge already initialized at {target}")
        return 1

    print(f"Initializing SkillForge at {target}")
    ...
    print()
    print("SkillForge initialized successfully.")
    print("Next steps:")
    print("  1. Add skills: forge add-skill 'My Skill' --owner my-team")
    print("  2. Add plugins to plugins/registry.json")
    print("  3. Run: forge validate")
    return 0
...
def cmd_audit(args):
    ...
    print("SkillForge Governance Audit")
    print("=" * 50)
    print()
...
def build_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="forge",
        description="SkillForge - Unified Lifecycle Governance CLI",
    )
    subparsers = parser.add_subparsers(dest="command", help="Available commands")

    # init
    subparsers.add_parser("init", help="Initialize SkillForge in current repo")
