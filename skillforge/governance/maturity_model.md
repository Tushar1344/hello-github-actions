# SkillForge Maturity Model

## Purpose

This document defines the maturity levels for SkillForge governance adoption.
...
**Key Indicators:**
- `.github/workflows/skillforge.yml` exists and runs
...
**Key Indicators:**
- `forge audit` returns zero issues
...
| From | To | Key Actions |
|------|-----|------------|
| 0 | 1 | Run `forge init`, define schemas, create registries |
| 1 | 2 | Implement validators, run `forge validate` |
